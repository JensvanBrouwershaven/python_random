import turtle
import random
 #dictates the height, width, how large the food is and how fast the snake moves
w = 550
h = 500
food_size = 25
delay = 100
 #shows which direction the snake is going
offsets = {
    "up": (0, 20),
    "down": (0, -20),
    "left": (-20, 0),
 ...
 #makes the diffrent snake variables
def reset():
...
def go_left():
    ...
    if snake_dir != "right":
        snake_dir = "left"
# Setup the screen and game elements
